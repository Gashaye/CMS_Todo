...
ActiveRecord::Schema.define(version: 2018_06_26_145351) do
  ...
  create_table "section_edits", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "admin_user_id"
